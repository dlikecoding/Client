...
export const ExpandIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
    <path stroke-width="0.5" d="M4 4v9h2V6h7V4H4zm15 0v2h7v7h2V4h-9zM4 19v9h9v-2H6v-7H4zm22 0v7h-7v2h9v-9h-2z" />
  </svg>
);

export const CompressIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
    <path stroke-width="0.5" d="M11 4v7H4v2h9V4h-2zm8 0v9h9v-2h-7V4h-2zM4 19v2h7v7h2v-9H4zm15 0v9h2v-7h7v-2h-9z" />
  </svg>
);
